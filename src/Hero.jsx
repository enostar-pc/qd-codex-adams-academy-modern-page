...
const Hero = () => {
  return (
    <div className="relative min-h-screen w-full overflow-hidden font-body bg-background text-foreground selection:bg-white/20">
      {/* Video Background */}
      <video
        autoPlay
        loop
      ...
      />
      <div className="absolute inset-0 z-0 bg-background/50 mix-blend-multiply pointer-events-none" />
      ...
      <main className="relative z-10 flex flex-col items-center justify-center text-center px-6 pt-32 pb-40 py-[90px] min-h-[calc(100vh-100px)]">
        ...
        >
          <em className="not-italic text-muted-foreground">Where dreams </em>
          rise 
        ...
        <button className="animate-fade-rise-delay-2 liquid-glass rounded-full px-14 py-5 text-base text-foreground mt-12 transition-transform duration-300 hover:scale-[1.03] cursor-pointer font-body">
          Begin Journey
        </button>
      </main>
    </div>
